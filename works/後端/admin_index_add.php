...
$stmt->bind_param("siissss",$_POST["date"],$_POST["number"],$_POST["money"],$_POST["name"],$_POST["phone"],$_POST["email"],$_POST["addr"]);
$stmt->execute();
$stmt->close();
$db_link->close();
...
<form action="admin_index_add.php" method="POST" accept-charset="utf-8">
...
<table class="table table-sm ">
	...
	<tbody>
		...
		<tr>
			<td>數量</td>
			<td><input type="number" name="number" value="" v-model="number" required></td>
		</tr><tr>
			<td>商品</td>
...
<center>
<a href="admin_index.php">回首頁</a></center>
</div></div></div>
