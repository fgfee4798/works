	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row" id="check_table">
				...
				<form action="check_reservation_submit" method="get" accept-charset="utf-8">
...
<table class="table table-bordered table-dark">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="2"><input type="submit" class="btn btn-dark" name="" value="查詢">
      		<input type="reset" class="btn btn-dark" name="" value="重填"></td>
    </tr>
  </tbody>
</table>
